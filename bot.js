...
.addField(`Alperen Bot | BILGI`, `**Selamlar, Ben Alperen (Alperen Bot'in Geliştiricisi) Öncelikle Alt Yapımızı Tercih Ettiğiniz İçin Teşşekür Ederim**`)
.addField(`Alperen Bot | BILGI`, `**BotV12 komutları bulunmaktadır 50+ fazla komut bulunmaktadır gerisine bakın kendiniz :wink: **`)
.setFooter(`ALPEREN Bot | Mutlu Bir Nefes | 2022`)
...
.setFooter(`ALPEREN Bot | A Happy Breath | 2022`)
.setTimestamp();
